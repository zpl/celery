...
NAMESPACES = {
    ...
    "BROKER": {
        "DEFAULT": Option("default", type="string", key=None),
        "URL": Option(None, type="string", key=None),
        "HOST": Option(None, type="string", key=None),
        "PORT": Option(type="int", key="port"),
        "USER": Option(None, type="string", key="userid"),
        "PASSWORD": Option(None, type="string", key="password"),
